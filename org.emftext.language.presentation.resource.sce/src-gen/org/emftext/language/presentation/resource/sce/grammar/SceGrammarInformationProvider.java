...
public class SceGrammarInformationProvider {
	...
	public final static org.emftext.language.presentation.resource.sce.grammar.SceLineBreak SCE_1_0_0_0_0_0_1 = new org.emftext.language.presentation.resource.sce.grammar.SceLineBreak(org.emftext.language.presentation.resource.sce.grammar.SceCardinality.ONE, 0);
	public final static org.emftext.language.presentation.resource.sce.grammar.SceSequence SCE_1_0_0_0_0_0 = new org.emftext.language.presentation.resource.sce.grammar.SceSequence(org.emftext.language.presentation.resource.sce.grammar.SceCardinality.ONE, SCE_1_0_0_0_0_0_0, SCE_1_0_0_0_0_0_1);
	...
	public final static org.emftext.language.presentation.resource.sce.grammar.SceContainment SCE_4_0_0_3 = new org.emftext.language.presentation.resource.sce.grammar.SceContainment(org.emftext.language.presentation.PresentationPackage.eINSTANCE.getDefinition().getEStructuralFeature(org.emftext.language.presentation.PresentationPackage.DEFINITION__VALUE), org.emftext.language.presentation.resource.sce.grammar.SceCardinality.ONE, new org.eclipse.emf.ecore.EClass[] {org.emftext.language.presentation.PresentationPackage.eINSTANCE.getLiteral(), }, 0);
	public final static org.emftext.language.presentation.resource.sce.grammar.SceKeyword SCE_4_0_0_4_0_0_0 = new org.emftext.language.presentation.resource.sce.grammar.SceKeyword(",", org.emftext.language.presentation.resource.sce.grammar.SceCardinality.ONE);
	public final static org.emftext.language.presentation.resource.sce.grammar.SceWhiteSpace SCE_4_0_0_4_0_0_1 = new org.emftext.language.presentation.resource.sce.grammar.SceWhiteSpace(1, org.emftext.language.presentation.resource.sce.grammar.SceCardinality.ONE);
	public final static org.emftext.language.presentation.resource.sce.grammar.SceContainment SCE_4_0_0_4_0_0_2 = new org.emftext.language.presentation.resource.sce.grammar.SceContainment(org.emftext.language.presentation.PresentationPackage.eINSTANCE.getDefinition().getEStructuralFeature(org.emftext.language.presentation.PresentationPackage.DEFINITION__VALUE), org.emftext.language.presentation.resource.sce.grammar.SceCardinality.ONE, new org.eclipse.emf.ecore.EClass[] {org.emftext.language.presentation.PresentationPackage.eINSTANCE.getLiteral(), }, 0);
	public final static org.emftext.language.presentation.resource.sce.grammar.SceSequence SCE_4_0_0_4_0_0 = new org.emftext.language.presentation.resource.sce.grammar.SceSequence(org.emftext.language.presentation.resource.sce.grammar.SceCardinality.ONE, SCE_4_0_0_4_0_0_0, SCE_4_0_0_4_0_0_1, SCE_4_0_0_4_0_0_2);
	public final static org.emftext.language.presentation.resource.sce.grammar.SceChoice SCE_4_0_0_4_0 = new org.emftext.language.presentation.resource.sce.grammar.SceChoice(org.emftext.language.presentation.resource.sce.grammar.SceCardinality.ONE, SCE_4_0_0_4_0_0);
	public final static org.emftext.language.presentation.resource.sce.grammar.SceCompound SCE_4_0_0_4 = new org.emftext.language.presentation.resource.sce.grammar.SceCompound(SCE_4_0_0_4_0, org.emftext.language.presentation.resource.sce.grammar.SceCardinality.STAR);
