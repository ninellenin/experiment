 ...
 */
public abstract class SceSyntaxElement {
	...
	public SceSyntaxElement(org.emftext.language.Presentation.resource.sce.grammar.SceCardinality cardinality, SceSyntaxElement[] children) {
		...
		if (this.children != null) {
			for (SceSyntaxElement child : this.children) {
	 ...
	 * once.
	 */
	public void setParent(SceSyntaxElement parent) {
	 ...
	 */
	public SceSyntaxElement getParent() {
		return parent;
	}
	
	public SceSyntaxElement[] getChildren() {
		if (children == null) {
			return new SceSyntaxElement[0];
		}
		return children;
	}
