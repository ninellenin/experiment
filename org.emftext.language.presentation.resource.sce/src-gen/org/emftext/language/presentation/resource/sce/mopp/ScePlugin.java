...
public class ScePlugin extends org.eclipse.core.runtime.Plugin {
	...
	private static ScePlugin plugin;
	...
	public static ScePlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, ScePlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, ScePlugin.PLUGIN_ID, message);
		}
		final ScePlugin pluginInstance = ScePlugin.getDefault();
