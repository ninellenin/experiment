 ...
 * @generated
 */
public class BooleanLiteralImpl extends GeneralLiteralImpl implements BooleanLiteral {
	/**
	...
	protected EClass eStaticClass() {
		return PresentationPackage.Literals.BOOLEAN_LITERAL;
	}
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PresentationPackage.BOOLEAN_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PresentationPackage.BOOLEAN_LITERAL__VALUE:
				return isValue();
		}
