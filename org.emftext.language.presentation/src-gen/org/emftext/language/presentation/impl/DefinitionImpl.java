...
public class DefinitionImpl extends StatementImpl implements Definition {
	...
	protected EClass eStaticClass() {
		return PresentationPackage.Literals.DEFINITION;
	}
	...
	public NotificationChain basicSetParameter(Parameter newParameter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PresentationPackage.DEFINITION__PARAMETER, oldParameter, newParameter);
	...
	public void setParameter(Parameter newParameter) {
		if (newParameter != parameter) {
			...
			if (parameter != null)
				msgs = ((InternalEObject)parameter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PresentationPackage.DEFINITION__PARAMETER, null, msgs);
			if (newParameter != null)
				msgs = ((InternalEObject)newParameter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PresentationPackage.DEFINITION__PARAMETER, null, msgs);
			msgs = basicSetParameter(newParameter, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PresentationPackage.DEFINITION__PARAMETER, newParameter, newParameter));
	}
