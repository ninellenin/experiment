 ...
 */
public class SceUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.Presentation.resource.sce.ui";
	public static final String EDITOR_ID = "org.emftext.language.Presentation.resource.sce.ui.SceEditor";
	...
	private static SceUIPlugin plugin;
	...
	public static SceUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SceUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SceUIPlugin.PLUGIN_ID, message);
		}
		final SceUIPlugin pluginInstance = SceUIPlugin.getDefault();
