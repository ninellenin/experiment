 ...
 * a specified depth.
 */
public class SceOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public SceOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
