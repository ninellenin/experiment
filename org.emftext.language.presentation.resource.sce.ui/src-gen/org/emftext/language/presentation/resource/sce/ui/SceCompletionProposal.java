 ...
 */
public class SceCompletionProposal implements java.lang.Comparable<SceCompletionProposal> {
	...
	public boolean equals(Object object) {
		if (object instanceof SceCompletionProposal) {
			SceCompletionProposal other = (SceCompletionProposal) object;
	...
	public int compareTo(SceCompletionProposal object) {
		if (object instanceof SceCompletionProposal) {
			SceCompletionProposal other = (SceCompletionProposal) object;
