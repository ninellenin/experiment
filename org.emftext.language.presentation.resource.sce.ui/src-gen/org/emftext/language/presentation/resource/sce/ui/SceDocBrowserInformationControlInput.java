 ...
 * olInput</code>.
 */
public class SceDocBrowserInformationControlInput {
	
	private final SceDocBrowserInformationControlInput fPrevious;
	private SceDocBrowserInformationControlInput fNext;
	 ...
	 */
	public SceDocBrowserInformationControlInput(SceDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public SceDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public SceDocBrowserInformationControlInput getNext() {
		return fNext;
	}
