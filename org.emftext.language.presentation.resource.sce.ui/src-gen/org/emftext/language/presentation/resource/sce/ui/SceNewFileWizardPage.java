 ...
 */
public class SceNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public SceNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new sce file");
